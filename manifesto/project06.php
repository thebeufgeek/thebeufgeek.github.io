...
<!-- Mirrored from manifesto.clapat.com/project07.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2023 21:48:17 GMT -->
<head>
                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image autoscroll">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width text-align-center parallax-scroll-caption">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span><em>Serene</em> Sheets</span></h1>
                            ...
                            <div id="hero-description" class="content-max-width">
                                <div class="inner">
                                    ...
                                    <p class="has-opacity">Experience the magic of our template's shortcodes on our project pages, where imagination meets functionality.</p>
                                    <br>
                                    ...
                                    <hr> 
                                    <p class="has-animation">[ <a class="link-text" target="_blank" href="https://themeforest.net/user/clapat/portfolio"><span class="link" data-hover="View Website">View Website</span></a> ]</p>
                                </div>
                            </div>
                            <div id="hero-footer">
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                        	...
                        	<!-- Row -->
                            <div class="content-row row_padding_top light-section change-header-color" data-bgcolor="#f9f9f9">
                                
                                <div class="one_half">
                                	<h3 class="has-mask-fill block-title">The Carousel</h3>
                                    <p class="has-opacity">It is a classic, yet you can always showcase stunning galleries in a carousel slider format.</p>
                                </div>
                            ...
                            <!-- Row -->
                            <div class="content-row full light-section change-header-color" data-bgcolor="#f9f9f9">
                                ...
                                <div class="clapat-slider-wrapper content-slider looped-carousel has-animation autocenter dark-cursor">
        							<div class="clapat-slider">
                                        <div class="clapat-slider-viewport">
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/serene01.jpg" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/serene02.jpg" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/serene03.jpg" alt="Image Title"></div></div>
                                            <div class="clapat-slide"><div class="slide-img"><img src="images/projects/serene04.jpg" alt="Image Title"></div></div>
                                        </div>
                                    </div>
                            ...
                            <div class="content-row row_padding_bottom light-section change-header-color" data-bgcolor="#f9f9f9">
                                ...
                                <div class="one_half last">
                                	<h3 class="has-mask-fill block-title">The Options</h3>
                                    <p class="has-opacity">Customize the gallery format to your preference: choose between large or small size, select the color for the cursor on hover, enable autocentering on click, and display dots navigation.</p>
                                    ...
                                    <div class="button-wrap right button-link large-btn has-animation">
                                        ...
                                        <a class="ajax-link" href="multimedia.php" data-type="page-transition"><div class="button-text sticky right">
                                        	<span data-hover="View More">View More</span></div>
                                        </a> 
                                    </div>
                            ...
                            <div class="content-row full dark-section" data-bgcolor="#171717">
                                ...
                                <figure class="has-parallax">
                                    <img src="images/projects/serene05.jpg" alt="Image Title">
                                    <div class="content-video-wrapper">
                                        <video loop muted playsinline class="bgvid">
                                            <source src="images/projects/serene.mp4" type="video/mp4">
                                        </video>
                                    </div>
                                    <div class="parallax-image-content content-max-width text-align-center">
                                    	<div class="outer">
                                            <div class="inner"> 
                                                <h2 class="has-mask-fill big-title">Enhance Your Sleep Experience with Serene Bed Sheets</h2>
                                            </div>
                                    	</div>
                                    </div>
                                </figure>
                        ...
                        <div id="project-nav" class="">
                            <div class="next-project-wrap">
                            	...
                            	<p class="all-works">[ <a class="link-text ajax-link" data-type="page-transition" href="index-showcase-carousel.php"><span class="link" data-hover="View All Works">View All Works</span></a> ]</p>
                                
                                <div class="next-project-caption text-align-center content-max-width">
                                    <div class="next-caption-wrapper">
                                    	<div class="caption-wrapper">
                                            <a class="next-ajax-link-project auto-trigger" data-type="page-transition" href="project08.php" data-color="#963a8d" data-firstline="Next" data-secondline="Project"></a>
                                            <div class="next-caption"> 
                                                <div class="next-hero-counter"><span>0</span></div>                                                                                           
                                                <div class="next-hero-title primary-font-title"><span><em>Rustic</em> Wonders</span></div>
                                ...
                                <div class="next-project-image-wrapper">
                                    <div class="next-project-image">
                                        <div class="next-project-image-bg" style="background-image:url(images/08hero.jpg)"></div>
                                    </div>            
                                </div>
...
<!-- Mirrored from manifesto.clapat.com/project07.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2023 21:48:59 GMT -->
</html>