                    ...
                    <div id="main-content">
                        ...
                        <div id="itemsWrapperLinks">                               
                            <div id="itemsWrapper" class="webgl-fitthumbs fx-six">
                            	...
                            	<!-- ClaPat Slider -->
                            	<div class="clapat-slider-wrapper showcase-gallery tilt-gallery">    
                                                    ...
                                                    <div class="slide-inner photo-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>The Handbag</span></div>
                                                ...
                                                <div class="slide-events speed-50 has-scale-medium">                                            
                                                    <div class="slide-inner design-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>Woolen Craft</span></div>
                                                                <div class="slide-cat"><span>Graphic Design</span></div>                                           
                                                            </div>
                                                        </div>
                                                	</div>
                                                ...
                                                <div class="slide-events has-scale-small">                                                
                                                    <div class="slide-inner photo-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>Urban Edge</span></div>
                                                                <div class="slide-cat"><span>Graphic Design</span></div>                                           
                                                            </div>
                                                        </div>
                                                	</div>
                                                ...
                                                <div class="slide-events speed-50">                                            
                                                    <div class="slide-inner video-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>The Camarades</span></div>
                                                                <div class="slide-cat"><span>Graphic Design</span></div>                                           
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="slide-events has-scale-medium">
                                                    <div class="slide-inner design-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>Storm Guard</span></div>
                                                                <div class="slide-cat"><span>Graphic Design</span></div>                                           
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="slide-events speed-50">
                                                    <div class="slide-inner photo-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>Heritage Car Rides</span></div>
                                                                <div class="slide-cat"><span>Graphic Design</span></div>                                           
                                                            </div>
                                                        </div>
                                                	</div>
                                                ...
                                                <div class="slide-events has-scale-small">                                            
                                                    <div class="slide-inner design-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>Serene Sheets</span></div>
                                                                <div class="slide-cat"><span>Graphic Design</span></div>                                           
                                                            </div>
                                                        </div>
                                                	</div>
                                                ...
                                                <div class="slide-events speed-50 has-scale-medium">
                                                    <div class="slide-inner photo-filter" data-centerLine="VIEW">
                                                        <div class="slide-moving">
                                                            ...
                                                            <div class="slide-caption">
                                                                <div class="slide-title"><span>Rustic Wonders</span></div>
                                                                <div class="slide-cat"><span>Graphic Design</span></div>                                           
                                                            </div>
                                                        </div>
                                                	</div>
                                        ...
                                        <div class="slider-fixed-content">
                                            <div id="slide-inner-temporary" class="fadeout-element">
                                                <div id="slide-inner-caption" class="content-full-width text-align-center block-title">
                                                    <div class="inner">
                                                        <h1 class="slide-hero-title caption-timeline"><span><em>These Projects</em></span><span> Are Too Valuable</span><span>To Be Lost</span></h1>
                                                        <div class="slide-hero-subtitle caption-timeline"><span>Reviving the past with a touch of creativity</span></div>
                                                    </div>
                                                </div> 
                                            </div>
                                        </div>
                ...
                <footer class="hidden">        	
                    <div id="footer-container">
                        ...
                        <div id="filters-wrapper" class="link">                        	
                            ...
                            <ul id="filters">
                                <li class="filters-timeline link active"><a id="all" href="#" data-filter="*" class="">All</a></li>
