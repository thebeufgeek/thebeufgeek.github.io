                    ...
                    <div id="hero" class="has-image autoscroll">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width text-align-center parallax-scroll-caption">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span><em>Woolen</em> Craft</span></h1>
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                            ...
                            <div class="content-row row_padding_top light-section change-header-color text-align-center" data-bgcolor="#fff">
                                ...
                                <h2 class="has-mask-fill block-title">The Branding</h2>                                    
                                <p class="has-opacity">Unveil the Pinned Gallery: Scroll to Reveal</p>
                            ...
                            <div class="content-row text-align-center row_padding_bottom light-section change-header-color" data-bgcolor="#fff">
                                ...
                                <div class="pinned-gallery">
                                    <div class="pinned-image">
                                        <img src="images/projects/cast01.jpg" alt="Image Title">
                                    </div>
                                    <div class="pinned-image">
                                        <img src="images/projects/cast02.jpg" alt="Image Title">
                                    </div>
                                    <div class="pinned-image">
                                        <img src="images/projects/cast03.jpg" alt="Image Title">
                                    </div>
                                    <div class="pinned-image">
                                        <img src="images/projects/cast04.jpg" alt="Image Title">
                                    </div>
                                </div>
                            ...
                            <div class="content-row small row_padding_bottom light-section change-header-color text-align-center" data-bgcolor="#fff">
                                ...
                                <h5 class="has-mask-fill">Add Unlimited Images for Stunning Presentations. Embrace Serendipity with Random Image Rotations.</h5>
                            ...
                            <div class="next-project-wrap">
                                ...
                                <div class="next-project-caption text-align-center content-max-width">
                                    <div class="next-caption-wrapper">
                                    	<div class="caption-wrapper">
                                            <a class="next-ajax-link-project auto-trigger" data-type="page-transition" href="project03.php" data-color="#963a8d" data-firstline="Next" data-secondline="Project"></a>
                                            <div class="next-caption"> 
                                                <div class="next-hero-counter"><span>0</span></div>                                                                                           
                                                <div class="next-hero-title primary-font-title"><span><em>Urban</em> Edge</span></div>
                                ...
                                <div class="next-project-image-wrapper">
                                    <div class="next-project-image">
                                        <div class="next-project-image-bg" style="background-image:url(images/03hero.jpg)"></div>
                                    </div>            
                                </div>
