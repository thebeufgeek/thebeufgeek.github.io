...
<!-- Mirrored from manifesto.clapat.com/project08.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2023 21:48:59 GMT -->
<head>
                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image autoscroll">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width text-align-center parallax-scroll-caption">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline"><span><em>Rustic</em> Wonders</span></h1>
                            ...
                            <div id="hero-description" class="content-max-width">
                                <div class="inner">
                                    ...
                                    <p class="has-opacity">Step into a world of limitless creativity on our project pages, where shortcodes transform ideas into stunning reality.</p>
                                    <br>
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                        	...
                        	<!-- Row -->
                            <div class="content-row small row_padding_top row_padding_bottom light-section change-header-color text-align-center" data-bgcolor="#fff">
                                
                                <h3 class="has-mask-fill">Reveal Cards</h3> 
                                <p class="no-margins"><span class="has-opacity">This shortcode enables you to reveal multiple image instances making it </span> <br> <span class="has-opacity">effortless to compare them side by side.</span></p>
                            ...
                            <!-- Row -->
                            <div class="content-row light-section change-header-color text-align-center" data-bgcolor="#fff">
                                
                                <div class="reveal-gallery">
                                    <div class="reveal-img">
                                        <img src="images/projects/leafs01.jpg">
                                    </div>
                                    <div class="reveal-img-fixed">
                                        <img src="images/projects/leafs02.jpg">
                                    </div>
                                    <div class="reveal-img">
                                        <img src="images/projects/leafs03.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="content-row small row_padding_top row_padding_bottom light-section change-header-color text-align-center" data-bgcolor="#fff">
                                ...
                                <h3 class="has-mask-fill">Thank you</h3>
                                <p class="has-opacity">For watching our portfolio template</p>
                                        ...
                                        <div class="clapat-button parallax-element">
                                            <div class="button-border outline rounded parallax-element-second">
                                                <a target="_blank" rel="nofollow" href="https://themeforest.net/user/clapat/portfolio">
                                                    <span data-hover="Buy Template">Buy Template</span>
                                                 </a>
                                             </div>
                                        </div>
                                    </div> 
                                ...
                                <div class="next-project-caption text-align-center content-max-width">
                                    <div class="next-caption-wrapper">
                                    	<div class="caption-wrapper">
                                            <a class="next-ajax-link-project auto-trigger" data-type="page-transition" href="project01.php" data-color="#963a8d" data-firstline="Next" data-secondline="Project"></a>
                                            <div class="next-caption"> 
                                                <div class="next-hero-counter"><span>0</span></div>                                                                                           
                                                <div class="next-hero-title primary-font-title"><span><em>The</em> Handbag</span></div>
...
<!-- Mirrored from manifesto.clapat.com/project08.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2023 21:49:33 GMT -->
</html>