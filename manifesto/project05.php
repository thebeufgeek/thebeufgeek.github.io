                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image autoscroll">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width text-align-center parallax-scroll-caption">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span><em>Heritage</em> Car Rides</span></h1>
                            ...
                            <div id="hero-description" class="content-max-width">
                                <div class="inner">
                                    ...
                                    <p class="has-opacity">Unleash your creativity with our template's dynamic shortcodes, showcased on our project pages for endless possibilities.</p>
                                    <br>
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                            ...
                            <!-- Row -->
                            <div class="content-row row_padding_top row_padding_bottom light-section change-header-color" data-bgcolor="#f9f9f9">
                                
                                <div class="one_half"></div>
                                
                                <div class="one_half last">
                                	<h3 class="has-mask-fill block-title">The Galleries</h3>
                                    <p class="has-opacity">Create dynamic horizontal galleries that seamlessly translate left or right as you scroll, offering an immersive browsing experience.</p>
                                        ...
                                        <div class="clapat-button-wrap parallax-wrap hide-ball">
                                            <div class="clapat-button parallax-element">
                                                <div class="button-border outline rounded parallax-element-second">
                                                    <a target="_blank" rel="nofollow" href="https://themeforest.net/user/clapat/portfolio">
                            ...
                            <!-- Row -->
                            <div class="content-row row_padding_bottom text-align-center full light-section change-header-color" data-bgcolor="#f9f9f9">                          
                                
                                <div class="moving-gallery fw-gallery random-sizes">
                                    <ul class="wrapper-gallery">
                                        <li>
                                            <img src="images/projects/heritage01.jpg">                                            
                                        </li>
                                        <li>
                                            <img src="images/projects/heritage02.jpg">
                                        </li>
                                        <li>
                                            <img src="images/projects/heritage03.jpg">
                                        </li>
                                        <li>
                                            <img src="images/projects/heritage04.jpg">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="content-row row_padding_bottom light-section change-header-color" data-bgcolor="#f9f9f9">
                                ...
                                <div class="one_half">
                                	<h3 class="has-mask-fill block-title">The Direction</h3>
                                    <p class="has-opacity">Set the direction to either right or left by dynamically changing a single class within the shortcode.</p>
                                </div>
                            ...
                            <div class="content-row row_padding_bottom light-section change-header-color" data-bgcolor="#f9f9f9">
                                ...
                                <div class="one_half last">
                                	<h3 class="has-mask-fill">The Sizes</h3>
                                    <p class="has-opacity">You have the flexibility to set a fixed width or random sizes, as demonstrated in these examples.</p>
                                </div>
                                ...
                                <div class="next-project-caption text-align-center content-max-width">
                                    <div class="next-caption-wrapper">
                                    	<div class="caption-wrapper">
                                            <a class="next-ajax-link-project auto-trigger" data-type="page-transition" href="project07.php" data-color="#963a8d" data-firstline="Next" data-secondline="Project"></a>
                                            <div class="next-caption"> 
                                                <div class="next-hero-counter"><span>0</span></div>                                                                                           
                                                <div class="next-hero-title primary-font-title"><span><em>Serene</em> Sheets</span></div>
