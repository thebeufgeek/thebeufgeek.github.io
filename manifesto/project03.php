            ...
            <div id="content-scroll">
                ...
                <div id="main">
                    ...
                    <div id="hero" class="has-image autoscroll">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width text-align-center parallax-scroll-caption">
                                <div class="inner">   
                                    <h1 class="hero-title caption-timeline primary-font-title"><span><em>Urban</em> Edge</span></h1>
                            ...
                            <div id="hero-description" class="content-max-width">
                                <div class="inner">
                                    ...
                                    <p class="has-opacity">Experience the versatility of our template through captivating content on our project pages, made possible with a variety of shortcodes.</p>
                                    <br>
                    ...
                    <div id="main-content">
                        <div id="main-page-content">
                                ...
                                <div class="pinned-section">
                                    <div class="scrolling-element left">
                                        <figure class="has-animation">
                                            <a href="images/projects/urbanedge01.jpg" class="image-link"><img src="images/projects/urbanedge01.jpg" alt="Image Title"></a>
                                        </figure>
                                    </div>
                                    
                                    <div class="pinned-element right">
                                        <h3 class="has-mask-fill block-title">The Concept</h3>
                                        <p class="has-opacity">Create captivating sticky elements that remain fixed on the left or right side of an image as you scroll, adding an engaging visual experience to your website.</p>
                                    </div>
                                </div>
                            ...
                            <div class="content-row full dark-section" data-bgcolor="#171717">
                                ...
                                <figure class="has-parallax has-parallax-content" data-delay="100">
                                    <img src="images/projects/urbanedge03.jpg" alt="Image Title">
                                    	...
                                    	<div class="outer">
                                            <div class="inner">                                                                                                
                                                ...
                                                <div class="one_half last">
                                                	<h2 class="has-mask-fill">Embrace the City's Pulse with Modern Style and Attitude</h2>
                                                </div>
                                            </div>
                                    	</div>
                                    </div>
                            ...
                            <div class="content-row row_padding_top row_padding_bottom light-section change-header-color" data-bgcolor="#eee">
                                ...
                                <div class="pinned-section">
                                    <div class="pinned-element left">
                                        <h3 class="has-mask-fill block-title">The Result</h3>
                                        <p class="has-opacity">Create captivating sticky elements that remain fixed on the left or right side of an image as you scroll, adding an engaging visual experience to your website.</p>
                                    </div>
                                    
                                    <div class="scrolling-element right">
                                        <figure class="has-animation">
                                            <a href="images/projects/urbanedge02.jpg" class="image-link"><img src="images/projects/urbanedge02.jpg" alt="Image Title"></a>
                                        </figure>
                                    </div>
                                </div>
                        ...
                        <!-- Project Navigation --> 
                        <div id="project-nav" class="change-header">
                                ...
                                <div class="next-project-caption text-align-center content-max-width">
                                    <div class="next-caption-wrapper">
                                    	<div class="caption-wrapper">
                                            <a class="next-ajax-link-project auto-trigger" data-type="page-transition" href="project04.php" data-color="#963a8d" data-firstline="Next" data-secondline="Project"></a>
                                            <div class="next-caption"> 
                                                <div class="next-hero-counter"><span>0</span></div>                                                                                           
                                                <div class="next-hero-title primary-font-title"><span><em>The</em> Camarades</span></div>
...
<!-- Mirrored from manifesto.clapat.com/project03.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2023 21:32:27 GMT -->
</html>