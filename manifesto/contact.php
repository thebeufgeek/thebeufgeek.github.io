                ...
                <div id="main">
                    ...
                    <div id="hero">
                        <div id="hero-styles">
                            <div id="hero-caption" class="content-full-width parallax-scroll-caption text-align-center">
                                <div class="inner">                                    
                                    <h1 class="hero-title caption-timeline"><span><em>Let's create</em></span> <span>something great</span> <span>together</span></h1>
                                    <div class="hero-subtitle caption-timeline"><span>Contact us and let's bring your vision to life</span></div>                 
                                </div>
                            </div>                                  
                        </div>
                    </div>                      
                    ...
                    <div id="main-content">
                        ...
                        <div id="main-page-content" class="content-max-width">
                            ...
                            <!-- Row -->
                            <div class="content-row row_padding_bottom dark-section text-align-center" data-bgcolor="#0c0c0c">
                                ...
                                <div id="contact-formular">
                                    ...
                                    <form method="post" action="http://manifesto.clapat.com/contact.php" name="contactform" id="contactform">                             
                                        <div class="name-box">        
                            ...
                            <!-- Row -->
                            <div class="content-row full dark-section has-clip-path" data-bgcolor="#333">
                            ...
                            <!-- Row -->
                            <div class="content-row small row_padding_top dark-section" data-bgcolor="#0c0c0c">
                                
                                <div class="one_half">                                
                                	<h5>for any enquires  or just to say hello get in touch with us</h5>
                                </div>
                                ...
                                <div class="one_half last">
                                	<p class="no-margins bigger">Mail Support</p>
                                    <p class="bigger"><a href="mailto:office@manifesto.com" class="link"><span class="has-mask-fill">office@manifesto.com</span></a></p>
                                    
                                    <hr><hr>
                                    <p class="no-margins bigger">We are social</p>
                                    <p class="no-margins bigger"><a class="link" href="https://www.facebook.com/clapat.ro" target="_blank"><span class="has-mask-fill">Facebook</span></a></p>
                                    <p class="no-margins bigger"><a class="link" href="https://www.dribbble.com/clapat" target="_blank"><span class="has-mask-fill">Dribbble</span></a></p>
                                    <p class="no-margins bigger"><a class="link" href="https://www.instagram.com/clapat.themes/"><span class="has-mask-fill">Instagram</span></a></p>
                                    <p class="no-margins bigger"><a class="link" href="https://www.twitter.com/clapatdesign" target="_blank"><span class="has-mask-fill">Twitter</span></a></p>
                                    <p class="no-margins bigger"><a class="link" href="https://www.behance.com/clapat" target="_blank"><span class="has-mask-fill">Behance</span></a></p> 
                                    
                                    <hr><hr>
                                    <p class="no-margins bigger">Give us a call</p>
                            ...
                            <!-- Row -->
                            <div class="content-row full dark-section text-align-center" data-bgcolor="#0c0c0c">
                                
                                <h2 class="big-title link"><em>004</em> (0742) 016 572</h2>
                                
                            </div> 
                            <!--/Row -->
                            
                            <!-- Row -->
                            <div class="content-row small row_padding_bottom dark-section" data-bgcolor="#0c0c0c">
                                ...
                                <div class="one_half last">
                                	<p class="no-margins bigger">Are we in your area?</p>
                                    <p class="no-margins bigger has-mask-fill">820 Porto Street, San Francisco</p>
                                    <p class="no-margins bigger has-mask-fill">CA, 941230</p>
